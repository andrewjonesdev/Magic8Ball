...
public class Magic8BallException {
			...
			do{
				...
				try{
					if((question.isEmpty())){
						...
						System.out.println("You asked: " + question + "\nMagic 8 Ball says: " + answers[random.nextInt(answers.length+10)]);
					}
					else{
				...
				{
					System.out.println("The answer the Magic 8 Ball gave does not exist!");
				}
				catch(Exception e2){
					System.out.println("Error!");
				}
				finally{
					System.out.println("You passed the exception check!");
				}
